...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.restservice.GreetingControllerTests", () -> new AotSpringBootConfigContextLoader(GreetingControllerTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.restservice.GreetingControllerTests", GreetingControllerTestsContextInitializer.class);
    return entries;
  }
}
