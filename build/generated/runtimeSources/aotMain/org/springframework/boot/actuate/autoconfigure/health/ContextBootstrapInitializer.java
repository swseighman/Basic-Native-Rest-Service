...
public final class ContextBootstrapInitializer {
  ...
  public static void registerHealthEndpointConfiguration_healthContributorRegistry(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("healthContributorRegistry", HealthContributorRegistry.class).withFactoryMethod(HealthEndpointConfiguration.class, "healthContributorRegistry", ApplicationContext.class, HealthEndpointGroups.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(HealthEndpointConfiguration.class).healthContributorRegistry(attributes.get(0), attributes.get(1)))).register(beanFactory);
  }

  public static void registerHealthEndpointConfiguration_healthEndpoint(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("healthEndpoint", HealthEndpoint.class).withFactoryMethod(HealthEndpointConfiguration.class, "healthEndpoint", HealthContributorRegistry.class, HealthEndpointGroups.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(HealthEndpointConfiguration.class).healthEndpoint(attributes.get(0), attributes.get(1)))).register(beanFactory);
  }
  ...
  public static void registerHealthEndpointWebExtensionConfiguration_healthEndpointWebExtension(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("healthEndpointWebExtension", HealthEndpointWebExtension.class).withFactoryMethod(HealthEndpointWebExtensionConfiguration.class, "healthEndpointWebExtension", HealthContributorRegistry.class, HealthEndpointGroups.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(HealthEndpointWebExtensionConfiguration.class).healthEndpointWebExtension(attributes.get(0), attributes.get(1)))).register(beanFactory);
  }
}
